...
Per provare il codice prendiamo una [Immagine](Immagini/image_pre_nomr.png) campione dal Fold 1 del dataset [PanNuke](https://warwick.ac.uk/fac/cross_fac/tia/data/pannuke) .   
