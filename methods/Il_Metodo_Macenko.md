...
$C_{\text{normalized}} = \frac{C - \mu_C}{\sigma_C} \times \sigma_T + \mu_T$ , con $μ_{c}$ e $\sigma_C$ rispettivamente la deviazione media e standard delle concentrazioni correnti, mentre $\mu_t$ e $\sigma_T$ la deviazione media e standard delle concentrazioni target
